...
const RULES: [Category, RegExp][] = [
  ...
  ['ストラップ', /ストラップ/],
  ['クリアファイル', /クリアファイル/],
  // BD/W95-069 這類是ヴァイスシュヴァルツ的 BanG Dream 卡包代號，不是 Blu-ray
  ['カード', /ヴァイス|プレシャスメモリーズ|トレーディングカード|トレカ|カードダス|\bpr\d|bd\/(w|s)\d+|カード(?!ケース|ホルダー)/],
  ['色紙', /色紙/],
  ['ペンライト', /ペンライト|サイリウム|キンブレ/],
  ['衣類', /tシャツ|パーカー|ジャージ|コスプレ|衣装|制服/],
  ['ゲーム', /switch|ニンテンドー|nintendo|プレイステーション|ps[345]|ゲームソフト/],
  ['書籍', /画集|漫画|コミック|書籍|雑誌|楽譜|バンドスコア|スコア|小説|アンソロジー|ガイドブック|イラスト集/],
